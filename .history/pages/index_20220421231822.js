    ...
    <div>
      ...
      <main>
        <div className=" relative z-0 ">
          ...
          <div className="absolute top-20 ml-10 mt-32 z-40">
            <div className="flex flex-row justify-evenly border-0 shadow-xl w-5/6 m-auto rounded-xl p-5   bg-white ">
              <div className=" border-r-2 border-Gray pr-24 z-40">
                <h3>IP ADDRESS</h3>
                <h2> 192.168.1.1 </h2>
              </div>
              <div className=" border-r-2 border-Gray pl-24 pr-24 z-40">
                <h3> LOCATION </h3>
