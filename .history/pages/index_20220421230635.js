    ...
    <div>
      ...
      <main>
        <div className=" relative z-0 ">
          ...
          <div
            className="flex flex-row justify-evenly border-0 shadow-xl w-4/6 m-auto rounded-xl p-10 absolute inset-0  
           items-center z-10 bg-white "
          >
