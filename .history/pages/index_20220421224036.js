...
export default function Home() {
  return (
    <div>
      ...
      <main>
        <div className="  ">
          <div className="bg-Backdrop h-80 bg-no-repeat	 bg-cover relative z-20 ">
          ...
          <div className="flex flex-row justify-evenly border-0 shadow-xl w-4/6 m-auto rounded-xl p-10 absolute top-24 z-40 ">
