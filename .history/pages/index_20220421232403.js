    ...
    <div>
      ...
      <main>
        <div className=" relative z-0 ">
          ...
          <div className="absolute top-20 ml-80 mt-36 z-40">
            <div className="flex flex-row justify-evenly border-0 shadow-2xl w-5/6 m-auto rounded-xl p-2  bg-white ">
              <div className=" border-r-2 border-Gray p-10 w-64">
                <h3>IP ADDRESS</h3>
                <h2> 192.168.1.1 </h2>
              </div>
              <div className=" border-r-2 border-Gray p-10 w-96">
                <h3> LOCATION </h3>
