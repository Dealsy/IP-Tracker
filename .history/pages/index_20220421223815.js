...
export default function Home() {
  return (
    <div>
      ...
      <main>
        <div className="bg-Backdrop h-80 bg-no-repeat	 bg-cover static ">
        ...
        <div className="flex flex-row justify-evenly border-0 shadow-xl w-4/6 m-auto rounded-xl p-10 absolute top-24 ">
